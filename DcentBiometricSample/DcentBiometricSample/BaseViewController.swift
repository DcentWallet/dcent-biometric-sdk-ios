...
//        }
    ...
    func AlgorandTransactionTest () {
        self.present(alertController, animated: true, completion: nil)
        print("\n>>> Algorand Transaction <<< \n")
        let algorandTransaction : AlgorandTransaction = AlgorandTransaction(sigHash: "", key: "", fee: "", decimals: 0, symbol: "", optionParam: "")
        algorandTransaction.sigHash = ""
        algorandTransaction.key = "m/44'/283'/0'/0/0"
        algorandTransaction.fee = "0.001"
        algorandTransaction.decimals = 6
        algorandTransaction.symbol = "ALGO"
        algorandTransaction.optionParam = "00"

        // test data
        DcentMgr.getAlgorandSignedTransaction(coinType: .ALGORAND, algorandTransaction: algorandTransaction) { (result, txData) in
            self.dismiss(animated: true, completion: nil)
            print("Algorand Transaction closure")
            if result == false {
                print("FAIL !!!")
                var tempString : String
                self.testLog.text.removeAll()
    ...
    func AlgorandAssetTransactionTest () {
        self.present(alertController, animated: true, completion: nil)
        print("\n>>> Algorand Asset Transaction <<< \n")
        let algorandTransaction : AlgorandTransaction = AlgorandTransaction(sigHash: "", key: "", fee: "", decimals: 0, symbol: "", optionParam: "")

        // test data
        algorandTransaction.sigHash = ""
        algorandTransaction.key = "m/44'/283'/0'/0/0"
        algorandTransaction.fee = "0.001"
        algorandTransaction.decimals = 2
        algorandTransaction.symbol = "DTN"
        algorandTransaction.optionParam = "01"
        
        DcentMgr.getAlgorandSignedTransaction(coinType: .ALGORAND_ASSET, algorandTransaction: algorandTransaction) { (result, txData) in
            self.dismiss(animated: true, completion: nil)
            print("Algorand Asset Transaction closure")
            if result == false {
                print("FAIL !!!")
                var tempString : String
                self.testLog.text.removeAll()
    ...
    func AlgorandAppTransactionTest () {
        self.present(alertController, animated: true, completion: nil)
        print("\n>>> Algorand App Transaction <<< \n")
        let algorandTransaction : AlgorandTransaction = AlgorandTransaction(sigHash: "", key: "", fee: "", decimals: 0, symbol: "", optionParam: "")

        // test data
        algorandTransaction.sigHash = ""
        algorandTransaction.key = "m/44'/283'/0'/0/0"
        algorandTransaction.fee = "0.001"
        algorandTransaction.decimals = 2
        algorandTransaction.symbol = "DTN"
        algorandTransaction.optionParam = "03"
        
        DcentMgr.getAlgorandSignedTransaction(coinType: .ALGORAND_ASSET, algorandTransaction: algorandTransaction) { (result, txData) in
            self.dismiss(animated: true, completion: nil)
            print("Algorand App Transaction closure")
            if result == false {
                print("FAIL !!!")
                var tempString : String
                self.testLog.text.removeAll()
...
//
    ...
    let PickerViewArray = [
        ...
        /* 46 */, "ALGORAND Transaction"
        /* 47 */, "ALGORAND ASSET Transaction"
        /* 48 */, "ALGORAND APP Transaction"
    ]
    ...
    @IBAction func SendCommand(_ sender: Any) {
        ...
        switch pickerSelectedCmdIdx {
            ...
            case 46: AlgorandTransactionTest(); break
            case 47: AlgorandAssetTransactionTest(); break
            case 48: AlgorandAppTransactionTest(); break
            default: break
        }
    }
}
